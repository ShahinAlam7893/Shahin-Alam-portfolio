  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      child: Column(
        ...
        children: [
          Text("Let's Connect", style: TextStyle(fontSize: 52.sp, fontWeight: FontWeight.bold))
              .animate().fadeIn().slideY(),

          SizedBox(height: 30.h),
          Text("I'm always open to discussing new opportunities, collaborations, or just a conversation about technology and Flutter/AI.",
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(minimumSize: Size(double.infinity, 60.h)),
                      ),
                    ],
                  ),
